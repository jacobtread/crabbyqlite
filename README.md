...
![Database Structure Screen](./docs/images/database-structure-screen.png)

## Browse database tables

![Browse Screen](./docs/images/browse-screen.png)

## Query your database

![Query Screen](./docs/images/query-screen.png)
